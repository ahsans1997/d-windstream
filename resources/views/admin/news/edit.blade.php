                    ...
                    <div class="news-form mt-3">
                        <form action="{{ route('news.update',$news->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mt-2">
                                ...
                                <textarea name="description" class="summernote form-control" rows="6">{{ $news->description }}</textarea>
                            </div>
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="form-control" id="placeholderInput" value="{{ $news->meta_keywords }}" placeholder="KeyWord" name="meta_keywords">
                                    </div>
                                    <div class="mt-2">
