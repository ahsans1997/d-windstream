        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form mt-3">
                        <form action="{{ route('noc.store') }}" method="post" enctype="multipart/form-data">
                            @csrf

                            <div>
                                <label for="placeholderInput" class="form-label">NOC Title</label>
                                <input type="text" class="form-control" id="placeholderInput" placeholder="Noc Name" name="title">
                            </div>
