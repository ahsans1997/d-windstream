    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="form">
                    <form action="{{ route('labfacility.store') }}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div>
                            <label for="placeholderInput" class="form-label">Lab Facility Title</label>
                            <input type="text" class="form-control" id="placeholderInput" placeholder="Lab Facility Title" name="title">
                        </div>
                        <div class="mt-2">
