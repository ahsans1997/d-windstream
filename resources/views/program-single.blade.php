...
<div class="main-div">
    ...
    <div class="container program-single">
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="">
                    <h2 class="mb-5"><strong>{{ $program->name }} ({{$program->duration_in_month}})</strong></h2>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="accordion">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header" id="semister{{$semister->id}}">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link" data-toggle="collapse"
                                                        data-target="#semisterCollapse{{$semister->id}}" aria-expanded="true"
                                            ...
                                            <div id="semisterCollapse{{$semister->id}}" class="collapse" aria-labelledby="semister{{$semister->id}}"
                                                ...
                                                <div class="card-body">
                                                    <ul>
                                                        ...
                                                        <div class="title">
                                                            ...
                                                            Cr.
                                                            <a data-toggle="modal" data-target="#subjects{{$subject->id}}"
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="subjects{{$subject->id}}" tabindex="-1"
