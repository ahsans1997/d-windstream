    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul>
                ...
                <li><a class="{{ request()->path() == 'about' ? 'active' : '' }}" href="{{ route('about') }}">About</a>
                </li>
                <li><a class="{{ request()->path() == 'program' ? 'active' : '' }}"
                        href="{{ route('program') }}">Programs</a></li>
                <li><a class="{{ request()->path() == 'news' ? 'active' : '' }}" href="{{ route('news') }}">News</a>
                </li>
                <li><a class="{{ request()->path() == 'event' ? 'active' : '' }}"
                        href="{{ route('event') }}">Events</a></li>
                <li><a class="{{ request()->path() == 'department' ? 'active' : '' }}"
                        href="{{ route('department') }}">Departments</a></li>
                <li><a class="{{ request()->path() == 'research' ? 'active' : '' }}"
                        href="{{ route('research') }}">Research</a></li>
                <li><a class="{{ request()->path() == 'contact' ? 'active' : '' }}"
